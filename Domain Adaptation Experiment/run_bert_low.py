...
if __name__ == '__main__':
    ...
    parser.add_argument('--trainDomain', type=str, default="data")
    parser.add_argument('--testDomain', type=str, default="data")
    ...
    wandb.init(project="bert-512-seq-len-itr-1-low-resource", config=args)
    ...
    if args.trainDomain == args.testDomain:
        ...
        # Extracting only 10% of train_text and train_label
        ten_percent = int(0.1 * len(train_text))
        train_text = train_text[:ten_percent]
        train_labels = train_labels[:ten_percent]
    ...
    best_model_path = "models/bert_train_" + str(args.trainDomain) + "_test_" + str(
                args.testDomain) + "_trainSeqLen_" + str(trainSequenceLength) + "_testSeqLen_" + str(
                testSequenceLength) + ".pt"
