...
if __name__ == '__main__':
    ...
    wandb.init(project="hc3-baseline-bert-newhps-itr1", config=args)
    ...
    for epoch in tqdm.tqdm(range(epochs)):
        ...
        if valid_accuracy > best_valid_acc:
            ...
            model_name = "final_bert_train_" + str(args.trainDomain) + "_test_" + str(
    ...
    best_model_path = "models/final_bert_train_" + str(args.trainDomain) + "_test_" + str(
                args.testDomain) + "_trainSeqLen_" + str(trainSequenceLength) + "_testSeqLen_" + str(
                testSequenceLength) + ".pt"
