...
# importing roberta
bert = AutoModel.from_pretrained('roberta-base') #Using bert as a variable but its roberta in this file
...
if __name__ == '__main__':
    ...
    wandb.init(project="domain-adaptation-baseline-roberta-512_seq_len_itr_2-main", config=args)
    ...
    for epoch in tqdm.tqdm(range(epochs)):
        ...
        if valid_accuracy > best_valid_acc:
            ...
            model_name = "roberta_train_" + str(args.trainDomain) + "_test_" + str(
    ...
    best_model_path = "models/roberta_train_" + str(args.trainDomain) + "_test_" + str(
                args.testDomain) + "_trainSeqLen_" + str(trainSequenceLength) + "_testSeqLen_" + str(
                testSequenceLength) + ".pt"
